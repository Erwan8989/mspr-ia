...
public class ClientChoisirPlanteGardiennage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.client_choisir_plante_gardiennage);
        ...
        btn_ajout_commentaire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v2) {
                try {
                    ...
                    VolleySingleton
                            .getInstance(ClientChoisirPlanteGardiennage.this)
                            .postData("/plant/" + id + "/comment", respObj, response -> Toast
                                    .makeText(ClientChoisirPlanteGardiennage.this, "Commentaire ajouté", Toast.LENGTH_SHORT)
                                    .show());
    ...
    public void refresh(String nom, String espece, String description, String date, String url, String id) {
        Intent intent = new Intent(this, ClientChoisirPlanteGardiennage.class);
